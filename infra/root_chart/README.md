...
| recoverer.affinity | object | `{}` |  |
| recoverer.annotations."argocd.argoproj.io/sync-wave" | string | `"4"` |  |
| recoverer.appSettings.app.module | string | `"recoverer"` |  |
| recoverer.autoscaling | object | `{}` |  |
| recoverer.configMountPath | string | `"/app/config"` |  |
| recoverer.envFromSecret | string | `"tin"` |  |
| recoverer.image.pullPolicy | string | `"IfNotPresent"` |  |
| recoverer.image.repository | string | `"nitroso-tin-recoverer"` |  |
| recoverer.image.tag | string | `""` |  |
| recoverer.imagePullSecrets | list | `[]` |  |
| recoverer.jobRbac.create | bool | `false` |  |
| recoverer.nameOverride | string | `"tin-recoverer"` |  |
| recoverer.nodeSelector | object | `{}` |  |
| recoverer.podAnnotations | object | `{}` |  |
| recoverer.podSecurityContext | object | `{}` |  |
| recoverer.replicaCount | int | `1` |  |
| recoverer.resources | object | `{}` |  |
| recoverer.securityContext | object | `{}` |  |
| recoverer.serviceAccount.create | bool | `false` |  |
| recoverer.serviceTree.<<.landscape | string | `"lapras"` |  |
| recoverer.serviceTree.<<.layer | string | `"2"` |  |
| recoverer.serviceTree.<<.platform | string | `"nitroso"` |  |
| recoverer.serviceTree.<<.service | string | `"tin"` |  |
| recoverer.serviceTree.module | string | `"recoverer"` |  |
| recoverer.stateful | bool | `false` |  |
| recoverer.tolerations | list | `[]` |  |
| recoverer.topologySpreadConstraints | object | `{}` |  |
